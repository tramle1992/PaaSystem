...
{
    public partial class FormInvPrint : BaseForm
    {
        ...
        public delegate void DoWorkEventHandler(FormInvPrint sender, DoWorkEventArgs e);
        /// <summary>
        ...
        {
            get { return (int)numericUpDownPrint.Value; }
        }
        ...
        public void SetupPrinting(InvPrintType invPrintType, List<ClientData> clients, List<InvoiceData> invoices)
        {
            Clients = clients;
            Invoices = invoices;
            if (invPrintType == InvPrintType.ByClientPastDue)
            {
                listBoxPrint.DataSource = Clients;
                listBoxPrint.ValueMember = "ClientId";
                listBoxPrint.DisplayMember = "ClientName";
            }
            else
            {
                listBoxPrint.DataSource = Invoices;
                listBoxPrint.ValueMember = "InvoiceId";
                listBoxPrint.DisplayMember = "ClientName";
            }
        }
