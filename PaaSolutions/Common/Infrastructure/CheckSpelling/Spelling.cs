...
namespace Common.Infrastructure.CheckSpelling
{
    public class Spelling : System.ComponentModel.Component
    {
        ...
        public event EventHandler<EventArgs> OnCancelSuggestionForm;
        #endregion
        ...
        private void Initialize()
        {
            ...
            if (_suggestionForm == null)
            {
                ...
                _suggestionForm.OnCancel += _suggestionForm_OnCancel;
            }
        }

        private void _suggestionForm_OnCancel(object sender, EventArgs e)
        {
            if (this.OnCancelSuggestionForm != null)
            {
                this.OnCancelSuggestionForm(sender, e);
            }
        }
        ...
        public bool SpellCheck(int startWordIndex, int endWordIndex)
        {
            ...
            {
                _suggestionForm.UpdateDisplay(this.Text, string.Empty, 0, 0);
        ...
        public bool TestWord(string word)
        {
            ...
            //    return true;
            //}
            string wordInTitleCase = CultureInfo.CurrentCulture.TextInfo.ToTitleCase(word.ToLower());
            if (this.Dictionary.Contains(word.ToLower()) && word.Equals(wordInTitleCase))
            {
                return true;
            }
            return false;
        ...
        private bool _ignoreWordsWithDigits = true;
        ...
        private bool _suggestionFormEndOfTextEvent = true;
        ...
        public bool SuggestionFormEndOfTextEvent
        {
            get { return _suggestionFormEndOfTextEvent; }
            set { _suggestionFormEndOfTextEvent = value; }
        }
        #endregion
